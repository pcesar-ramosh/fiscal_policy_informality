...
% (multiplicative in utility). Type-specific borrowing premia (theta_I/F).
% Diffusion over assets + bisection on r to satisfy A_priv = B.
% -------------------------------------------------------------------------
...
% Switching calibrated to target informality
...
% report_G = arg('report_G_effects',0); % (optional hook)
...
% Initial V consistent with Gpc=0
