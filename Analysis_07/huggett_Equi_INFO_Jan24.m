...
%  Run solver para eta = [0.20, 0.64] y deja variables
%  en el workspace con los nombres que usa el main de gráficos.
% =============================================================
clearvars -except -regexp ^(runningFromMain)$
rng(123);

RRA = 4.20;             % RRA base (benchmark cambiar)
...
% Nota: las variables quedan en el workspace y el "main" de gráficos
