%% ==============================================================
%  main_covid_scenarios_transfer_FIXED.m
%  Benchmark vs. COVID shock (incomes down; transfers go UP)
%  Versión corregida (Sept 2025)
%  Cambios clave:
%   - Fracción en restricción condicional por ocupación
%   - Export robusto con cuantiles/gini resistentes
%   - Bracket de r* ampliado
%% ==============================================================
...
% Bracket más amplio para evitar "edge"
cfg_base.r0                    = 0.00;
cfg_base.rmin                  = -0.02;
cfg_base.rmax                  = 0.05;

[r_b, ir_b, pop_b, a_b, g_b, c_b] = ...
    huggett_Equi_RRA_function_transfer_on_FIXED(eta_vector, sI_vector1, sF_vector1, cfg_base);
...
[r_c, ir_c, pop_c, a_c, g_c, c_c] = ...
    huggett_Equi_RRA_function_transfer_on_FIXED(eta_vector, sI_vector1, sF_vector1, cfg_covid);
