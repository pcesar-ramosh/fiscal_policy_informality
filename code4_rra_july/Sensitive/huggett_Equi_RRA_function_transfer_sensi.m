...
function [r_opt, ir, pop1_vector, a, g_opt, c_opt] =...
         huggett_Equi_RRA_function_transfer_sensi(eta_vector, sI_vector1, sF_vector1, phi)
...
p22 = 0.75; % 0.8155; %0.75; %0.20 oK % 0.8155; % 0.8155;   0.62=0.83 %Prob[y2|y2] = exp(-lambda_2) | From lognormal.m (Luis Y.) Sensible
...
% Tax rate
taxF = 0.10; %0.17; % 0.17; %0.17; %0.18; 0.15;
taxI = 0.00;
%%%phi = 0.05; %%% Transfers
...
%phi = 0; % 0.04; %0.06; %0.06; %0.04;  %0.05;                % proporción del ingreso informal que se transfiere
...
Gov = TaxRevenue - Transfer * popI;  % se descuenta el gasto focalizado
